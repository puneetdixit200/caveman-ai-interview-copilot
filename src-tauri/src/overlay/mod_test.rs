use super::{
    ...
    COMPANION_WINDOW_BACKGROUND_REPAIR_MARKER, COMPANION_WINDOW_BOUNDS_REPAIR_MARKER,
...
fn repairs_tiny_offscreen_companion_window_to_centered_monitor_bounds() {
    ...
    assert!(COMPANION_WINDOW_BACKGROUND_REPAIR_MARKER.contains("privacy shield stays clear"));
