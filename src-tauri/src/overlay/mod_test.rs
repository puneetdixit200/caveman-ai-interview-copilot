use super::{
    ...
    COMPANION_WINDOW_WATCHDOG_VISIBLE_RESTORE_MARKER,
    MACOS_NATIVE_PRIVACY_HIDE_REINFORCEMENT_MARKER,
    MACOS_NATIVE_PRIVACY_RESTORE_REINFORCEMENT_MARKER, OVERLAY_POST_SHOW_SHARE_RISK_MARKER,
    ...
    WINDOWS_NATIVE_PRIVACY_HIDE_REINFORCEMENT_MARKER,
...
fn repairs_tiny_offscreen_companion_window_to_centered_monitor_bounds() {
    ...
    assert!(COMPANION_WINDOW_WATCHDOG_PRIVACY_PAUSE_MARKER.contains("screen-share risk"));
    assert!(COMPANION_WINDOW_WATCHDOG_VISIBLE_RESTORE_MARKER.contains("privacy clears"));
    assert!(COMPANION_WINDOW_FOREGROUND_REPAIR_MARKER.contains("unusable bounds need repair"));
    assert!(COMPANION_WINDOW_NATIVE_BOUNDS_REPAIR_MARKER.contains("CoreGraphics"));
    ...
    assert!(WINDOWS_NATIVE_PRIVACY_HIDE_REINFORCEMENT_MARKER.contains("top-level windows"));
    assert!(MACOS_NATIVE_PRIVACY_HIDE_REINFORCEMENT_MARKER.contains("NSWindow"));
    assert!(MACOS_NATIVE_PRIVACY_RESTORE_REINFORCEMENT_MARKER.contains("ordered-out"));
