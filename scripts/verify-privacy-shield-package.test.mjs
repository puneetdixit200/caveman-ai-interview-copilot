...
const WINDOWS_ENUMWINDOWS_FAST_GATE_MARKER =
...
const MACOS_NATIVE_RESTORE_REINFORCEMENT_MARKER =
...
test("requires packaged web meeting and recording title detector markers", () => {
  ...
  assert.ok(COMMON_PRIVACY_SHIELD_MARKERS.includes("you are sharing a window"));
  assert.ok(COMMON_PRIVACY_SHIELD_MARKERS.includes("you are sharing this tab"));
  assert.ok(COMMON_PRIVACY_SHIELD_MARKERS.includes("you're sharing a window"));
  assert.ok(COMMON_PRIVACY_SHIELD_MARKERS.includes("you're sharing your screen"));
  ...
  assert.ok(COMMON_PRIVACY_SHIELD_MARKERS.includes("sharing is active"));
  assert.ok(COMMON_PRIVACY_SHIELD_MARKERS.includes("sharing is paused"));
  ...
  assert.ok(COMMON_PRIVACY_SHIELD_MARKERS.includes("your screen is being shared"));
  assert.ok(COMMON_PRIVACY_SHIELD_MARKERS.includes("your window is being shared"));
  assert.ok(COMMON_PRIVACY_SHIELD_MARKERS.includes("your tab is being shared"));
  ...
  assert.ok(COMMON_PRIVACY_SHIELD_MARKERS.includes("meeting is being recorded"));
  assert.ok(COMMON_PRIVACY_SHIELD_MARKERS.includes("call is being recorded"));
  assert.ok(COMMON_PRIVACY_SHIELD_MARKERS.includes("recording in progress"));
...
test("requires packaged protection refresh fail-closed marker", () => {
  ...
  assert.ok(WINDOWS_NATIVE_PRIVACY_SHIELD_MARKERS.includes(WINDOWS_ENUMWINDOWS_FAST_GATE_MARKER));
  assert.ok(TARGET_PRIVACY_SHIELD_MARKERS["windows-x64"].includes(WINDOWS_ENUMWINDOWS_FAST_GATE_MARKER));
  assert.ok(!TARGET_PRIVACY_SHIELD_MARKERS["macos-arm64"].includes(WINDOWS_ENUMWINDOWS_FAST_GATE_MARKER));
  assert.ok(!TARGET_PRIVACY_SHIELD_MARKERS["macos-x64"].includes(WINDOWS_ENUMWINDOWS_FAST_GATE_MARKER));
  assert.ok(!TARGET_PRIVACY_SHIELD_MARKERS["linux-x64"].includes(WINDOWS_ENUMWINDOWS_FAST_GATE_MARKER));
  ...
  assert.ok(WINDOWS_NATIVE_PRIVACY_SHIELD_MARKERS.includes(WINDOWS_TOOLHELP_PROCESS_MARKER));
  assert.ok(TARGET_PRIVACY_SHIELD_MARKERS["windows-x64"].includes(WINDOWS_TOOLHELP_PROCESS_MARKER));
  ...
  assert.ok(MACOS_NATIVE_PRIVACY_SHIELD_MARKERS.includes(MACOS_NATIVE_RESTORE_REINFORCEMENT_MARKER));
  assert.ok(TARGET_PRIVACY_SHIELD_MARKERS["macos-arm64"].includes(MACOS_NATIVE_RESTORE_REINFORCEMENT_MARKER));
  assert.ok(TARGET_PRIVACY_SHIELD_MARKERS["macos-x64"].includes(MACOS_NATIVE_RESTORE_REINFORCEMENT_MARKER));
  assert.ok(!TARGET_PRIVACY_SHIELD_MARKERS["windows-x64"].includes(MACOS_NATIVE_RESTORE_REINFORCEMENT_MARKER));
  assert.ok(!TARGET_PRIVACY_SHIELD_MARKERS["linux-x64"].includes(MACOS_NATIVE_RESTORE_REINFORCEMENT_MARKER));
  assert.ok(
    TARGET_PRIVACY_SHIELD_MARKERS["macos-arm64"].includes(
      "macOS process screen-share guard skips window-title scan after direct capture-process match."
    )
